-- ============================================================
-- MÓDULO PLANEJAMENTO (plan_) — planejamento e gestão de processos
--   • plan_plans / plan_plan_items: planos de trabalho e planejamento
--     organizacional (objetivos → metas → ações, formato 5W2H);
--   • plan_boards / plan_board_columns / plan_board_cards /
--     plan_board_members / plan_card_comments: quadros Kanban/Scrum;
--   • plan_diagrams / plan_diagram_versions: fluxogramas, mapas de
--     processo e diagramas (JSON do editor visual próprio, versionado);
--   • plan_templates: modelos predefinidos (editáveis) de planos,
--     quadros e diagramas.
