-- ============================================================================
--  015 — Módulo Meu espaço (organização pessoal)
--
--  Cria as três tabelas da primeira etapa do módulo: agenda, notas e
--  tarefas. O mesmo conteúdo de sql/modules/meu.sql, repetido aqui porque
--  sql/modules/*.sql só roda na instalação nova — quem já tem o portal no ar
--  recebe as tabelas por esta migração.
--
--  Idempotente.
-- ============================================================================
