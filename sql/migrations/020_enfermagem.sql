-- ============================================================================
--  020 — Módulo Enfermagem: Busca Fonada da CCIH
--
--  Cria as tabelas enf_* da vigilância pós-alta de Infecção de Sítio
--  Cirúrgico (ISC). Mesmo conteúdo de sql/modules/enfermagem.sql, repetido
--  aqui porque sql/modules/*.sql só roda em instalação nova — quem já tem o
--  portal no ar recebe as tabelas por esta migração.
--
