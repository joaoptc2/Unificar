...
class DependentController
{
    ...
    public function store(): void
    {
        ...
        if (!$empId || !$name) { Session::flash('error', 'Nome obrigatorio.'); header('Location: index.php?page=employees&action=show&id=' . $empId); exit; }
        ...
        Session::flash('success', 'Dependente cadastrado.'); header('Location: index.php?page=employees&action=show&id=' . $empId); exit;
    }
    public function delete(): void
    {
        ...
        Session::flash('success', 'Dependente removido.'); header('Location: index.php?page=employees&action=show&id=' . $empId); exit;
    }
}
