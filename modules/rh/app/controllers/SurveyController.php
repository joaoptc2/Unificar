...
class SurveyController
{
    ...
    public function store(): void
    {
        ...
        foreach ($questions as $q) {
            ...
            $this->db->prepare('INSERT INTO rh_survey_questions (survey_id, question, type, sort_order) VALUES (?,?,?,?)')
    ...
    public function respond(): void
    {
        ...
        if (!$survey || $survey['status'] !== 'ativa') { Session::flash('error', 'Pesquisa indisponivel.'); header('Location: index.php?m=rh&page=surveys'); exit; }
        ...
        foreach ($answers as $qId => $val) {
            ...
            $this->db->prepare('INSERT INTO rh_survey_responses (survey_id, question_id, user_id, rating, answer) VALUES (?,?,?,?,?)')
