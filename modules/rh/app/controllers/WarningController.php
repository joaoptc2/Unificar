...
class WarningController
{
    ...
    public function store(): void
    {
        ...
        if (!$empId || !$reason || !$date) { Session::flash('error', 'Preencha todos os campos.'); header('Location: index.php?page=employees&action=show&id=' . $empId); exit; }
        $filePath = null;
        ...
        Session::flash('success', 'Advertencia registrada.'); header('Location: index.php?page=employees&action=show&id=' . $empId); exit;
    }
    public function delete(): void
    {
        ...
        Session::flash('success', 'Advertencia removida.'); header('Location: index.php?page=employees&action=show&id=' . $empId); exit;
    }
}
