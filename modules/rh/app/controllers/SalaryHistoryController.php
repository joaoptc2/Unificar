...
class SalaryHistoryController
{
    ...
    public function store(): void
    {
        ...
        if (!$empId || $salary <= 0 || !$date) { Session::flash('error', 'Preencha todos os campos.'); header('Location: index.php?page=employees&action=show&id=' . $empId); exit; }
        ...
        Session::flash('success', 'Historico salarial atualizado.'); header('Location: index.php?page=employees&action=show&id=' . $empId); exit;
    }
